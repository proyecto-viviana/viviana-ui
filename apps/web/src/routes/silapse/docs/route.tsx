...
const navItems: NavEntry[] = [
  ...
  { section: "Components", items: buildSectionItems(componentPages, "/silapse/docs/components", componentOrder, toTitleCase) },
  { section: "Hooks", items: buildSectionItems(hookPages, "/silapse/docs/hooks", hookOrder, toCamelCase) },
];
...
function DocsLayout() {
  ...
  const isActive = (href: string) => {
    ...
    return href === "/silapse/docs" ? path === "/silapse/docs" || path === "/silapse/docs/" : path === href;
  };
