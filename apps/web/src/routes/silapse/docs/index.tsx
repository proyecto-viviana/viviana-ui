  ...
  return (
    <Button onPress={() => setPressed(true)}>
      ...
      <div style={{ display: "flex", "flex-direction": "column", gap: "0", margin: "0.75rem 0", border: `1px solid ${colors().muted}`, background: colors().surface }}>
        ...
        <ArchRow name="@proyecto-viviana/solid-spectrum" desc="Styled components ready to use (Button, Select, Table, etc.)" color={colors().blue} border={colors().muted} />
      </div>
      ...
      <ul style={{ "padding-left": "1.25rem", "margin-bottom": "1.5rem" }}>
        <li style={{ "margin-bottom": "0.375rem" }}>
          <Link to="/silapse/docs/installation" style={{ color: colors().blue, "text-decoration": "none", "font-weight": "500" }}>Installation</Link> — Set up the packages in your project
        </li>
        <li style={{ "margin-bottom": "0.375rem" }}>
          <Link to="/silapse/docs/components/button" style={{ color: colors().blue, "text-decoration": "none", "font-weight": "500" }}>Components</Link> — Explore the component library
        </li>
        <li style={{ "margin-bottom": "0.375rem" }}>
          <Link to="/silapse/docs/hooks/create-button" style={{ color: colors().blue, "text-decoration": "none", "font-weight": "500" }}>Hooks</Link> — Build custom components with ARIA hooks
        </li>
      </ul>
    </div>
  );
