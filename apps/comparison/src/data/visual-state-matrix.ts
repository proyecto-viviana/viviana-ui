...
const officialStateOverrides: Record<string, readonly VisualStateTarget[]> = {
  ...
  button: [
    ...
    {
      id: "styled.default.row",
      label: "Styled default row",
      kind: "static",
      react: "snapshotted",
      solid: "snapshotted",
      pairDiff: "strict",
      ...
      snapshots: [
        "e2e/button-visual.spec.ts-snapshots/button-default-row-react-chromium-linux.png",
        "e2e/button-visual.spec.ts-snapshots/button-default-row-solid-chromium-linux.png",
      ],
      note: "Button-specific row screenshots compare the exact React Spectrum S2 variants against the Solid S2 skin.",
    },
    {
      id: "styled.primary.hover",
      label: "Primary hover",
      kind: "interaction",
      react: "snapshotted",
      solid: "snapshotted",
      ...
      spec: "e2e/button-visual.spec.ts",
      snapshots: [
        "e2e/button-visual.spec.ts-snapshots/button-primary-hover-react-chromium-linux.png",
        "e2e/button-visual.spec.ts-snapshots/button-primary-hover-solid-chromium-linux.png",
      ],
      note: "Hover is snapshotted on both implementations and compared with zero pixel tolerance.",
    },
    {
      id: "styled.primary.focus-visible",
      ...
      spec: "e2e/button-visual.spec.ts",
      snapshots: [
        "e2e/button-visual.spec.ts-snapshots/button-primary-focus-visible-react-chromium-linux.png",
        "e2e/button-visual.spec.ts-snapshots/button-primary-focus-visible-solid-chromium-linux.png",
      ],
      note: "Keyboard focus ring is snapshotted on the full canvas so the outside outline is not clipped.",
    },
    {
      id: "styled.primary.pressed",
      ...
      spec: "e2e/button-visual.spec.ts",
      snapshots: [
        "e2e/button-visual.spec.ts-snapshots/button-primary-pressed-react-chromium-linux.png",
        "e2e/button-visual.spec.ts-snapshots/button-primary-pressed-solid-chromium-linux.png",
      ],
      note: "Pressed state includes the S2 press-scale transform and is compared with zero pixel tolerance.",
    },
    {
      id: "styled.primary.press-action",
      label: "Primary press action",
      kind: "interaction",
      react: "asserted",
      solid: "asserted",
      pairDiff: "na",
      spec: "e2e/button-family-contract.spec.ts",
      note: "Pressing Primary increments the same comparison action counter on both stacks.",
    },
    {
      id: "styled.disabled",
      ...
      solid: "planned",
      pairDiff: "planned",
      note: "Disabled primary, accent, and secondary examples are not in the Button fixture yet; add them before marking Button complete.",
    },
  ],
  actionbutton: [
    snapshottedDefaultState({
