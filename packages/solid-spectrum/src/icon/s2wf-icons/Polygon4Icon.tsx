...
function Polygon4IconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type Polygon4IconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const Polygon4Icon = createIcon(Polygon4IconSvg);
