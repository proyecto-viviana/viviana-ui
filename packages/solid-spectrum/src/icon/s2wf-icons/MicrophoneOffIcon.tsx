...
function MicrophoneOffIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type MicrophoneOffIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const MicrophoneOffIcon = createIcon(MicrophoneOffIconSvg);
