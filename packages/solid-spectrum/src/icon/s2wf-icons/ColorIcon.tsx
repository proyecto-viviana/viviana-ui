...
function ColorIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
  ...
  return (
    <svg
      ...
      class={className}
    >
      <circle cx="10.85885" cy="5.52114" r="1.5" fill="var(--iconPrimary, #222)" />
      <circle cx="6.85885" cy="7.52114" r="1.5" fill="var(--iconPrimary, #222)" />
      <circle cx="6.85885" cy="12.52114" r="1.5" fill="var(--iconPrimary, #222)" />
      <circle cx="10.85885" cy="14.52114" r="1.5" fill="var(--iconPrimary, #222)" />
      <path
...
export type ColorIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const ColorIcon = createIcon(ColorIconSvg);
