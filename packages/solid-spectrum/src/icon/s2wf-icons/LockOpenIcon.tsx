...
function LockOpenIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type LockOpenIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const LockOpenIcon = createIcon(LockOpenIconSvg);
