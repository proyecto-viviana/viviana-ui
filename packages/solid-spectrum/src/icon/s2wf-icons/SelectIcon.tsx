...
function SelectIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type SelectIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const SelectIcon = createIcon(SelectIconSvg);
