...
function GroupNoIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type GroupNoIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const GroupNoIcon = createIcon(GroupNoIconSvg);
export default GroupNoIcon;
