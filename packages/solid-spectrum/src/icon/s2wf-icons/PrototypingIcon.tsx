...
function PrototypingIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type PrototypingIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const PrototypingIcon = createIcon(PrototypingIconSvg);
