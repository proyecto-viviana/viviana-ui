...
function AddCircleIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type AddCircleIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const AddCircleIcon = createIcon(AddCircleIconSvg);
