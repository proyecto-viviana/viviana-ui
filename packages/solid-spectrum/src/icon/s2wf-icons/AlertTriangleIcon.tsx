...
function AlertTriangleIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type AlertTriangleIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const AlertTriangleIcon = createIcon(AlertTriangleIconSvg);
