...
function LocationIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type LocationIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const LocationIcon = createIcon(LocationIconSvg);
