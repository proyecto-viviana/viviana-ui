...
function AlertDiamondIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type AlertDiamondIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const AlertDiamondIcon = createIcon(AlertDiamondIconSvg);
