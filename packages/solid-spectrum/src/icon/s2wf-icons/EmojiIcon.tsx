...
function EmojiIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
  ...
  return (
    ...
    >
      ...
      />
      <circle cx="7.25" cy="8" r="1.25" fill="var(--iconPrimary, #222)" />
      <circle cx="12.75" cy="8" r="1.25" fill="var(--iconPrimary, #222)" />
      <path
      ...
      <path
        ...
        fill="var(--iconPrimary, #222)"
      />
      <circle cx="7.25" cy="8.02303" r="1.25" fill="var(--iconPrimary, #222)" />
      <circle cx="12.75" cy="8.02303" r="1.25" fill="var(--iconPrimary, #222)" />
      <path
...
export type EmojiIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const EmojiIcon = createIcon(EmojiIconSvg);
