...
function TemplateIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type TemplateIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const TemplateIcon = createIcon(TemplateIconSvg);
