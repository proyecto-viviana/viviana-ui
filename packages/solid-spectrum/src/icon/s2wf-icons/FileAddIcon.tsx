...
function FileAddIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type FileAddIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const FileAddIcon = createIcon(FileAddIconSvg);
