...
function BrandIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type BrandIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const BrandIcon = createIcon(BrandIconSvg);
