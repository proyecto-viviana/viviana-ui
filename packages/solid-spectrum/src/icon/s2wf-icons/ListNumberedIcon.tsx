...
function ListNumberedIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type ListNumberedIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const ListNumberedIcon = createIcon(ListNumberedIconSvg);
