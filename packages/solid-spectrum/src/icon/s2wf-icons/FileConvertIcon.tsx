...
function FileConvertIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type FileConvertIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const FileConvertIcon = createIcon(FileConvertIconSvg);
export default FileConvertIcon;
