...
function AccessibilityIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
  ...
  return (
    ...
    >
      <path
        ...
        stroke-width="0"
      />
      <circle cx="10" cy="5" r="1.25" fill="var(--iconPrimary, #222)" stroke-width="0" />
      <path
...
export type AccessibilityIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const AccessibilityIcon = createIcon(AccessibilityIconSvg);
