...
function ThumbDownIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type ThumbDownIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const ThumbDownIcon = createIcon(ThumbDownIconSvg);
