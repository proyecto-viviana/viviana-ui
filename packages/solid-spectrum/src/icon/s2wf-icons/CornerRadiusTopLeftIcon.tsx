...
function CornerRadiusTopLeftIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type CornerRadiusTopLeftIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const CornerRadiusTopLeftIcon = createIcon(CornerRadiusTopLeftIconSvg);
export default CornerRadiusTopLeftIcon;
