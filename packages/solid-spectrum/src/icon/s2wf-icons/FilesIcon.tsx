...
function FilesIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type FilesIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const FilesIcon = createIcon(FilesIconSvg);
