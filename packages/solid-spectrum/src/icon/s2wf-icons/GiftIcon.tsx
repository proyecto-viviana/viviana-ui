...
function GiftIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type GiftIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const GiftIcon = createIcon(GiftIconSvg);
