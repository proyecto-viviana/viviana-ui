...
function CornerRadiusBottomLeftIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type CornerRadiusBottomLeftIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const CornerRadiusBottomLeftIcon = createIcon(CornerRadiusBottomLeftIconSvg);
export default CornerRadiusBottomLeftIcon;
