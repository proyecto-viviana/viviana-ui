...
function SlowConnectionCircleIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type SlowConnectionCircleIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const SlowConnectionCircleIcon = createIcon(SlowConnectionCircleIconSvg);
export default SlowConnectionCircleIcon;
