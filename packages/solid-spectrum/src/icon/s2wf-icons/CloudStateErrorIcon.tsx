...
export type CloudStateErrorIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const CloudStateErrorIcon = createIcon(CloudStateErrorIconSvg);
export default CloudStateErrorIcon;
