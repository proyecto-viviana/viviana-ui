...
function ViewGridFluidIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type ViewGridFluidIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const ViewGridFluidIcon = createIcon(ViewGridFluidIconSvg);
export default ViewGridFluidIcon;
