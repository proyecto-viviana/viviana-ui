...
function ImageBackgroundRemoveIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type ImageBackgroundRemoveIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const ImageBackgroundRemoveIcon = createIcon(ImageBackgroundRemoveIconSvg);
export default ImageBackgroundRemoveIcon;
