...
function ABCIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type ABCIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const ABCIcon = createIcon(ABCIconSvg);
