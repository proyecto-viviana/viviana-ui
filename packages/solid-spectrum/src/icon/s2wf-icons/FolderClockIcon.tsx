...
function FolderClockIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type FolderClockIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const FolderClockIcon = createIcon(FolderClockIconSvg);
