...
function CornerRadiusTopRightIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type CornerRadiusTopRightIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const CornerRadiusTopRightIcon = createIcon(CornerRadiusTopRightIconSvg);
export default CornerRadiusTopRightIcon;
