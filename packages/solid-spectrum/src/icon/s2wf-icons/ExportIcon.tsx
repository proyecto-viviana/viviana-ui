...
function ExportIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type ExportIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const ExportIcon = createIcon(ExportIconSvg);
