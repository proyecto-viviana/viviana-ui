...
function Icon3DAssetIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type Icon3DAssetIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const Icon3DAssetIcon = createIcon(Icon3DAssetIconSvg);
export default Icon3DAssetIcon;
