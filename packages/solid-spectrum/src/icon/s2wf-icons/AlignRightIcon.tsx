...
function AlignRightIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type AlignRightIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const AlignRightIcon = createIcon(AlignRightIconSvg);
