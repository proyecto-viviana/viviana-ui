...
function FileUserIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type FileUserIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const FileUserIcon = createIcon(FileUserIconSvg);
