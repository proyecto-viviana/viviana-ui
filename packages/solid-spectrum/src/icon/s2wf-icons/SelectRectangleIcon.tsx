...
function SelectRectangleIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type SelectRectangleIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const SelectRectangleIcon = createIcon(SelectRectangleIconSvg);
