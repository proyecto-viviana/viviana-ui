...
function DeviceAllIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type DeviceAllIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const DeviceAllIcon = createIcon(DeviceAllIconSvg);
export default DeviceAllIcon;
