...
describe('ColorSwatchPicker (silapse)', () => {
  describe('basic rendering', () => {
    ...
    it('renders correct number of swatch items', () => {
      ...
      const items = container.querySelectorAll('.solidaria-ColorSwatchPickerItem, [class*="cursor-pointer"]');
  ...
  describe('rounding variants', () => {
    ...
    it('applies default rounding', () => {
      ...
      allElements.forEach(el => {
        if (el.className && typeof el.className === 'string' && el.className.includes('rounded') && !el.className.includes('rounded-none') && !el.className.includes('rounded-full')) {
