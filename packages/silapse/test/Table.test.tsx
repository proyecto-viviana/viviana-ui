    ...
    it('applies text-center alignment', () => {
      render(() => (
        <Table
          ...
          columns={columns}
          getKey={(r: any) => r.id}
          aria-label="Aligned table"
        >
          {() => (
            <>
              <TableHeader>
                <TableColumn id="name" align="center">{() => <>Name</>}</TableColumn>
                <TableColumn id="role" align="center">{() => <>Role</>}</TableColumn>
              </TableHeader>
              <TableBody>
                {(row: any) => (
                  <TableRow id={row.id} item={row}>
      ...
      render(() => (
        ...
        >
          {() => (
            <>
              <TableHeader>
                <TableColumn id="name" align="right">{() => <>Name</>}</TableColumn>
                <TableColumn id="role">{() => <>Role</>}</TableColumn>
              </TableHeader>
              <TableBody>
                {(row: any) => (
    ...
    it('applies inline width style', () => {
      render(() => (
        <Table
          ...
          columns={columns}
          getKey={(r: any) => r.id}
          aria-label="Width table"
        >
          {() => (
            <>
              <TableHeader>
                <TableColumn id="name" width="200px">{() => <>Name</>}</TableColumn>
                <TableColumn id="role">{() => <>Role</>}</TableColumn>
              </TableHeader>
              <TableBody>
                {(row: any) => (
