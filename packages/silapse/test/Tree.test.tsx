...
function createTestItems(): TreeItemData<TestItem>[] {
  return [
    ...
    },
    {
      ...
      textValue: 'Images',
      children: [
        { key: 'file-3', value: { name: 'Photo.jpg' }, textValue: 'Photo.jpg' },
      ],
    },
    {
      key: 'file-4',
  ...
  describe('expand/collapse', () => {
    it('expand button chevron has rotate-90 when expanded', () => {
      ...
      const chevronSvg = Array.from(svgs || []).find((svg) =>
        svg.className.baseVal?.includes('rotate-90') || svg.getAttribute('class')?.includes('rotate-90')
      );
    ...
    it('expand button chevron does NOT have rotate-90 when collapsed', () => {
      ...
      const rotatedSvg = Array.from(svgs || []).find((svg) =>
        svg.className.baseVal?.includes('rotate-90') || svg.getAttribute('class')?.includes('rotate-90')
      );
