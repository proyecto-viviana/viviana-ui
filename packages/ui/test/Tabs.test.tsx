...
describe('Tabs (ui)', () => {
  ...
  describe('keyboard navigation', () => {
    it('arrow keys update roving tabindex', async () => {
      ...
      // After arrow, the second tab should become focusable
      const newFocusable = tabs.find(
        (t) => t === document.activeElement || t.getAttribute('data-focus-visible') === 'true'
      );
      expect(newFocusable).toBeTruthy();
    });
  });
});
