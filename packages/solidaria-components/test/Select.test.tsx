...
describe('Select', () => {
  ...
  describe('rendering', () => {
    ...
    it('should support slot', () => {
      render(() => (
        <TestSelect selectProps={{ slot: 'test', 'aria-label': 'test' }} />
      ));
  ...
  describe('selection', () => {
          ...
          h(
            ...
            [
              ...
              h(
                ...
                {},
                (item: TestItem) => h(SelectOption, { id: item.id }, item.name),
              ),
            ],
          ),
    ...
    it('should support multiple selection form integration with many items', async () => {
      ...
      await waitFor(() => expect(screen.getByText('Constraints not satisfied')).toBeInTheDocument());
      ...
      expect(new FormData(screen.getByTestId('form') as HTMLFormElement).getAll('select')).toEqual(['0', '1']);
    ...
    it('should support extra children for use with the state', async () => {
      ...
      function SelectClearButton() {
        ...
        return (
          <button type="button" data-testid="clear" onClick={() => selectState?.setSelectedKey(null)}>
            Clear
          </button>
        );
      }
      ...
      function Test() {
        ...
        return (
          <form onSubmit={onSubmit}>
            ...
            />
            <button data-testid="submit" type="submit">Submit</button>
            <button data-testid="clear" type="button" onClick={() => setSelectedKey(null)}>Reset</button>
          </form>
        );
      }
